...
const patraPindaTherapyId = panchkarmaTherapyRates.find((therapy) => therapy.name === "PPS (PATRA PINDA SWEDAN)")?.id || "therapy-031";
const shirodharaTherapyId = panchkarmaTherapyRates.find((therapy) => therapy.name === "SIRO DHARA - KASHAYA")?.id || "therapy-048";

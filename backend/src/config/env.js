...
export const env = {
  ...
  jwtIssuer: process.env.JWT_ISSUER || "sr-aiims-hms",
  jwtAudience: process.env.JWT_AUDIENCE || "sr-aiims-hms-web",
  ...
  dbSslRejectUnauthorized: String(process.env.DB_SSL_REJECT_UNAUTHORIZED || "true").toLowerCase() === "true",
